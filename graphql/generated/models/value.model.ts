...
import definition from "@/graphql/schema/definitions/Value";
...
@post<Value>("findOneAndUpdate", async function (result) {
...
export class Value extends Model {
  ...
  //   mutationResponses: {
  //     create: { createValue: ValueFragment };
  //     update: { updateValue: ValueFragment };
  //     upsert: { upsertValue: ValueFragment };
  //     delete: { deleteValue: ValueFragment };
  //   };
  // }
