...
import { CreateCalendarArgs } from "@/graphql/schema/generated/args/calendar.args";
import {
  calendarFragment,
  CalendarFragment,
...
export const getOptimisticResponseForCalendarCreation = (data: CalendarCreateInput) => {
  const now = new Date();
  return {
    createCalendar: {
      __typename: "Calendar",
...
export const UPSERT_CALENDAR = gql`
  mutation UpdateCalendar($where: CalendarWhereUniqueInput!, $data: CalendarCreateInput!) {
