...
export class MetricApplicationCrudResolver {
  ...
  async metricApplication(
    ...
    return getPrismaFromContext(ctx).metricApplication.findUnique({
      ...args,
  ...
  async findFirstMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.findFirst({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async metricApplications(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.findMany({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async createMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.create({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async createManyMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.createMany({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async deleteMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.delete({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async updateMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.update({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async deleteManyMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.deleteMany({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async updateManyMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.updateMany({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async upsertMetricApplication(
    ...
    const { _count } = transformFields(graphqlFields(info));
    return getPrismaFromContext(ctx).metricApplication.upsert({
      ...args,
      ...(_count && transformCountFieldIntoSelectRelationsCount(_count)),
    });
  }
  ...
  async groupByMetricApplication(
    ...
    return getPrismaFromContext(ctx).metricApplication.groupBy({
      ...args,
      ...Object.fromEntries(
