...
@TypeGraphQL.InputType("UserUpdateWithoutNotebookPermissionsInput", {
  isAbstract: true,
})
export class UserUpdateWithoutNotebookPermissionsInput {
  ...
  @TypeGraphQL.Field((_type) => HabitUpdateManyWithoutUserInput, {
    nullable: true,
  })
