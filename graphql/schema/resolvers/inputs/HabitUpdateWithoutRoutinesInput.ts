...
@TypeGraphQL.InputType("HabitUpdateWithoutRoutinesInput", {
  isAbstract: true,
})
export class HabitUpdateWithoutRoutinesInput {
  ...
  @TypeGraphQL.Field((_type) => GoalUpdateManyWithoutHabitInput, {
    nullable: true,
  })
