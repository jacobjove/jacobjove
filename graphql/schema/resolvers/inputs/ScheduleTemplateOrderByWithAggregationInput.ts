...
export class ScheduleTemplateOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => ScheduleTemplateCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: ScheduleTemplateCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ScheduleTemplateAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: ScheduleTemplateAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ScheduleTemplateMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: ScheduleTemplateMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ScheduleTemplateMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: ScheduleTemplateMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ScheduleTemplateSumOrderByAggregateInput, {
    nullable: true,
  })
