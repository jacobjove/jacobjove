...
@TypeGraphQL.InputType("ListCreateWithoutOwnerInput", {
  isAbstract: true,
})
export class ListCreateWithoutOwnerInput {
  ...
  @TypeGraphQL.Field((_type) => ItemCreateNestedManyWithoutListInput, { nullable: true })
