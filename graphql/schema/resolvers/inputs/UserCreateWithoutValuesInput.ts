...
import { BookReviewCreateNestedManyWithoutUserInput } from "./BookReviewCreateNestedManyWithoutUserInput";
import { BookshelfCreateNestedManyWithoutOwnerInput } from "./BookshelfCreateNestedManyWithoutOwnerInput";
import { CalendarCreateNestedManyWithoutUserInput } from "./CalendarCreateNestedManyWithoutUserInput";
import { DashboardCreateNestedManyWithoutUserInput } from "./DashboardCreateNestedManyWithoutUserInput";
import { HabitCreateNestedManyWithoutUserInput } from "./HabitCreateNestedManyWithoutUserInput";
import { IdentityCreateNestedManyWithoutUserInput } from "./IdentityCreateNestedManyWithoutUserInput";
import { ListCreateNestedManyWithoutOwnerInput } from "./ListCreateNestedManyWithoutOwnerInput";
import { NotebookCreateNestedManyWithoutOwnerInput } from "./NotebookCreateNestedManyWithoutOwnerInput";
import { NotebookUserPermissionCreateNestedManyWithoutUserInput } from "./NotebookUserPermissionCreateNestedManyWithoutUserInput";
import { ReadingCreateNestedManyWithoutUserInput } from "./ReadingCreateNestedManyWithoutUserInput";
...
@TypeGraphQL.InputType("UserCreateWithoutValuesInput", {
  isAbstract: true,
})
export class UserCreateWithoutValuesInput {
