...
export class CalendarEventOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => CalendarEventCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: CalendarEventCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => CalendarEventAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: CalendarEventAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => CalendarEventMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: CalendarEventMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => CalendarEventMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: CalendarEventMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => CalendarEventSumOrderByAggregateInput, {
    nullable: true,
  })
