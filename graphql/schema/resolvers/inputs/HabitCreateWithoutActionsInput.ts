...
@TypeGraphQL.InputType("HabitCreateWithoutActionsInput", {
  isAbstract: true,
})
export class HabitCreateWithoutActionsInput {
  ...
  @TypeGraphQL.Field((_type) => MetricUsageCreateNestedManyWithoutHabitInput, {
    nullable: true,
  })
