...
export class ReadingOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => ReadingCountOrderByAggregateInput, { nullable: true })
  _count?: ReadingCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ReadingAvgOrderByAggregateInput, { nullable: true })
  _avg?: ReadingAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ReadingMaxOrderByAggregateInput, { nullable: true })
  _max?: ReadingMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ReadingMinOrderByAggregateInput, { nullable: true })
  _min?: ReadingMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ReadingSumOrderByAggregateInput, { nullable: true })
