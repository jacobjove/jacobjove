...
export class MetricOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => MetricCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: MetricCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: MetricAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: MetricMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: MetricMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricSumOrderByAggregateInput, {
    nullable: true,
  })
