...
@TypeGraphQL.InputType("BookUpdateWithoutShelvingsInput", {
  isAbstract: true,
})
export class BookUpdateWithoutShelvingsInput {
  ...
  @TypeGraphQL.Field((_type) => AuthorshipUpdateManyWithoutBookInput, {
    nullable: true,
  })
