...
export class ActOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => ActCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: ActCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ActAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: ActAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ActMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: ActMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ActMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: ActMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ActSumOrderByAggregateInput, {
    nullable: true,
  })
