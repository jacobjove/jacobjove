...
export class MetricApplicationOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => MetricApplicationCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: MetricApplicationCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricApplicationAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: MetricApplicationAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricApplicationMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: MetricApplicationMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricApplicationMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: MetricApplicationMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MetricApplicationSumOrderByAggregateInput, {
    nullable: true,
  })
