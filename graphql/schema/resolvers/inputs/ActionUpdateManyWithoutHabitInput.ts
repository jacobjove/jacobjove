...
export class ActionUpdateManyWithoutHabitInput {
  ...
  @TypeGraphQL.Field((_type) => [ActionCreateOrConnectWithoutHabitInput], {
    nullable: true,
  })
  connectOrCreate?: ActionCreateOrConnectWithoutHabitInput[] | undefined;

  @TypeGraphQL.Field((_type) => [ActionUpsertWithWhereUniqueWithoutHabitInput], {
    nullable: true,
  })
  upsert?: ActionUpsertWithWhereUniqueWithoutHabitInput[] | undefined;

  @TypeGraphQL.Field((_type) => ActionCreateManyHabitInputEnvelope, {
    nullable: true,
  })
  ...
  @TypeGraphQL.Field((_type) => [ActionUpdateWithWhereUniqueWithoutHabitInput], {
    nullable: true,
  })
  update?: ActionUpdateWithWhereUniqueWithoutHabitInput[] | undefined;

  @TypeGraphQL.Field((_type) => [ActionUpdateManyWithWhereWithoutHabitInput], {
    nullable: true,
  })
