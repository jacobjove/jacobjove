...
export class ReadingUpdateManyWithoutBookInput {
  @TypeGraphQL.Field((_type) => [ReadingCreateWithoutBookInput], {
    nullable: true,
  })
  create?: ReadingCreateWithoutBookInput[] | undefined;

  @TypeGraphQL.Field((_type) => [ReadingCreateOrConnectWithoutBookInput], {
    nullable: true,
  })
  connectOrCreate?: ReadingCreateOrConnectWithoutBookInput[] | undefined;

  @TypeGraphQL.Field((_type) => [ReadingUpsertWithWhereUniqueWithoutBookInput], {
    nullable: true,
  })
  upsert?: ReadingUpsertWithWhereUniqueWithoutBookInput[] | undefined;

  @TypeGraphQL.Field((_type) => ReadingCreateManyBookInputEnvelope, {
    nullable: true,
  })
  ...
  @TypeGraphQL.Field((_type) => [ReadingUpdateWithWhereUniqueWithoutBookInput], {
    nullable: true,
  })
  update?: ReadingUpdateWithWhereUniqueWithoutBookInput[] | undefined;

  @TypeGraphQL.Field((_type) => [ReadingUpdateManyWithWhereWithoutBookInput], {
    nullable: true,
  })
