...
export class MantraOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => MantraCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: MantraCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MantraAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: MantraAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MantraMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: MantraMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MantraMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: MantraMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => MantraSumOrderByAggregateInput, {
    nullable: true,
  })
