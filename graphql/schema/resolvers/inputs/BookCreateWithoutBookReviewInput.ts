...
@TypeGraphQL.InputType("BookCreateWithoutBookReviewInput", {
  isAbstract: true,
})
export class BookCreateWithoutBookReviewInput {
  ...
  @TypeGraphQL.Field((_type) => BookCreateauthorNamesInput, {
    nullable: true,
  })
  authorNames?: BookCreateauthorNamesInput | undefined;

  @TypeGraphQL.Field((_type) => BookCreateauthorNamesLfInput, {
    nullable: true,
  })
  authorNamesLf?: BookCreateauthorNamesLfInput | undefined;

  @TypeGraphQL.Field((_type) => AuthorshipCreateNestedManyWithoutBookInput, {
    nullable: true,
  })
  authorships?: AuthorshipCreateNestedManyWithoutBookInput | undefined;

  @TypeGraphQL.Field((_type) => ReadingCreateNestedManyWithoutBookInput, {
    nullable: true,
  })
  readings?: ReadingCreateNestedManyWithoutBookInput | undefined;

  @TypeGraphQL.Field((_type) => ShelvingCreateNestedManyWithoutBookInput, {
    nullable: true,
  })
