...
export class ValueOrderByWithAggregationInput {
  ...
  @TypeGraphQL.Field((_type) => ValueCountOrderByAggregateInput, {
    nullable: true,
  })
  _count?: ValueCountOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ValueAvgOrderByAggregateInput, {
    nullable: true,
  })
  _avg?: ValueAvgOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ValueMaxOrderByAggregateInput, {
    nullable: true,
  })
  _max?: ValueMaxOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ValueMinOrderByAggregateInput, {
    nullable: true,
  })
  _min?: ValueMinOrderByAggregateInput | undefined;

  @TypeGraphQL.Field((_type) => ValueSumOrderByAggregateInput, {
    nullable: true,
  })
