...
export class HabitUpdateManyWithoutActInput {
  ...
  @TypeGraphQL.Field((_type) => [HabitCreateOrConnectWithoutActInput], {
    nullable: true,
  })
  connectOrCreate?: HabitCreateOrConnectWithoutActInput[] | undefined;

  @TypeGraphQL.Field((_type) => [HabitUpsertWithWhereUniqueWithoutActInput], {
    nullable: true,
  })
  upsert?: HabitUpsertWithWhereUniqueWithoutActInput[] | undefined;

  @TypeGraphQL.Field((_type) => HabitCreateManyActInputEnvelope, {
    nullable: true,
  })
  ...
  @TypeGraphQL.Field((_type) => [HabitUpdateWithWhereUniqueWithoutActInput], {
    nullable: true,
  })
  update?: HabitUpdateWithWhereUniqueWithoutActInput[] | undefined;

  @TypeGraphQL.Field((_type) => [HabitUpdateManyWithWhereWithoutActInput], {
    nullable: true,
  })
