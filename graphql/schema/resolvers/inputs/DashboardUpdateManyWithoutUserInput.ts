...
export class DashboardUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field((_type) => [DashboardCreateOrConnectWithoutUserInput], {
    nullable: true,
  })
  ...
  @TypeGraphQL.Field((_type) => DashboardCreateManyUserInputEnvelope, {
    nullable: true,
  })
  ...
  @TypeGraphQL.Field((_type) => [DashboardUpdateManyWithWhereWithoutUserInput], {
    nullable: true,
  })
