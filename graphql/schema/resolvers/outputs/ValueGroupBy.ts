...
export class ValueGroupBy {
  ...
  @TypeGraphQL.Field((_type) => ValueCountAggregate, {
    nullable: true,
  })
  _count!: ValueCountAggregate | null;

  @TypeGraphQL.Field((_type) => ValueAvgAggregate, {
    nullable: true,
  })
  _avg!: ValueAvgAggregate | null;

  @TypeGraphQL.Field((_type) => ValueSumAggregate, {
    nullable: true,
  })
  _sum!: ValueSumAggregate | null;

  @TypeGraphQL.Field((_type) => ValueMinAggregate, {
    nullable: true,
  })
  _min!: ValueMinAggregate | null;

  @TypeGraphQL.Field((_type) => ValueMaxAggregate, {
    nullable: true,
  })
