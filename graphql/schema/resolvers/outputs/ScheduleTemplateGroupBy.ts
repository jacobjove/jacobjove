...
export class ScheduleTemplateGroupBy {
  ...
  @TypeGraphQL.Field((_type) => ScheduleTemplateCountAggregate, {
    nullable: true,
  })
  _count!: ScheduleTemplateCountAggregate | null;

  @TypeGraphQL.Field((_type) => ScheduleTemplateAvgAggregate, {
    nullable: true,
  })
  _avg!: ScheduleTemplateAvgAggregate | null;

  @TypeGraphQL.Field((_type) => ScheduleTemplateSumAggregate, {
    nullable: true,
  })
  _sum!: ScheduleTemplateSumAggregate | null;

  @TypeGraphQL.Field((_type) => ScheduleTemplateMinAggregate, {
    nullable: true,
  })
  _min!: ScheduleTemplateMinAggregate | null;

  @TypeGraphQL.Field((_type) => ScheduleTemplateMaxAggregate, {
    nullable: true,
  })
