...
export class IdentityActRelationGroupBy {
  ...
  @TypeGraphQL.Field((_type) => IdentityActRelationCountAggregate, {
    nullable: true,
  })
  _count!: IdentityActRelationCountAggregate | null;

  @TypeGraphQL.Field((_type) => IdentityActRelationAvgAggregate, {
    nullable: true,
  })
  _avg!: IdentityActRelationAvgAggregate | null;

  @TypeGraphQL.Field((_type) => IdentityActRelationSumAggregate, {
    nullable: true,
  })
  _sum!: IdentityActRelationSumAggregate | null;

  @TypeGraphQL.Field((_type) => IdentityActRelationMinAggregate, {
    nullable: true,
  })
  _min!: IdentityActRelationMinAggregate | null;

  @TypeGraphQL.Field((_type) => IdentityActRelationMaxAggregate, {
    nullable: true,
  })
