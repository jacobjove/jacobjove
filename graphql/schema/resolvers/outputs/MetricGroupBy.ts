...
export class MetricGroupBy {
  ...
  @TypeGraphQL.Field((_type) => MetricCountAggregate, {
    nullable: true,
  })
  _count!: MetricCountAggregate | null;

  @TypeGraphQL.Field((_type) => MetricAvgAggregate, {
    nullable: true,
  })
  _avg!: MetricAvgAggregate | null;

  @TypeGraphQL.Field((_type) => MetricSumAggregate, {
    nullable: true,
  })
  _sum!: MetricSumAggregate | null;

  @TypeGraphQL.Field((_type) => MetricMinAggregate, {
    nullable: true,
  })
  _min!: MetricMinAggregate | null;

  @TypeGraphQL.Field((_type) => MetricMaxAggregate, {
    nullable: true,
  })
