...
const DEFAULT_LAYOUTS: DashboardLayouts = {
  ...
  sm: [
    ...
    { i: "tasks", x: 6, y: 3, w: 2, h: 6, minH: 2, resizeHandles: ["se", "sw"] },
  ...
  md: [
    ...
    { i: "tasks", x: 6, y: 0, w: 3, h: 6, minH: 2, resizeHandles: ["se", "sw"] },
  ...
  lg: [
    ...
    { i: "tasks", x: 9, y: 0, w: 6, h: 10, minH: 2, resizeHandles: ["se", "sw"] },
