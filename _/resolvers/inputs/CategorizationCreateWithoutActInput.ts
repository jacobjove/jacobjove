...
@TypeGraphQL.InputType("CategorizationCreateWithoutActInput", { isAbstract: true })
export class CategorizationCreateWithoutActInput {
  ...
  @TypeGraphQL.Field(() => CategoryCreateNestedOneWithoutCategorizationsInput, { nullable: false })
